...
if (strlen(@$_POST["nome"]) == 0) {
    ...
    $sql_code = mysqli_query($conexao, "INSERT INTO clientes (nome, cnpj, email, telefone, endereco) VALUES ('$nome', '$cnpj', '$email', '$telefone', '$endereco')");
